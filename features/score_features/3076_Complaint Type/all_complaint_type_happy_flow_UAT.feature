@UAT_TEST_CASES
@SCORE_COMPLAINT_TYPE_UAT
Feature: Verify the Add , Edit and Delete Complaint Type with mandatory and with all fields data- Happy Flow

    # Verify Add Edit and Delete Allergic Reaction Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Allergic Reaction complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Allergic Reaction complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Allergic Reaction complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Allergic Reaction complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Allergic Reaction Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Allergic Reaction complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Allergic Reaction complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Allergic Reaction complaint type with all data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Allergic Reaction complaint type with all data for Submitted "Active" case
        
        
    # Verify Add Edit and Delete Economic Adulteration Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Economic Adulteration complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Economic Adulteration complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Economic Adulteration complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Economic Adulteration complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Economic Adulteration Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Economic Adulteration complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Economic Adulteration complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Economic Adulteration complaint type with all data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Economic Adulteration complaint type with all data for Submitted "Active" case
        
        
    # Verify Add Edit and Delete Foreign Object Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Foreign Object complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Foreign Object complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Foreign Object complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Foreign Object complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Foreign Object Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Foreign Object complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Foreign Object complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Foreign Object complaint type with all data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Foreign Object complaint type with all data for Submitted "Active" case



    # Verify Add Edit and Delete Illness Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Illness complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Illness complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Illness complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Illness complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Illness Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Illness complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Illness complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Illness complaint type with all data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Illness complaint type with all data for Submitted "Active" case


    # Verify Add Edit and Delete Injury Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Injury complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Injury complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Injury complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Injury complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Injury Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Injury complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Injury complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Injury complaint type with all data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Injury complaint type with all data for Submitted "Active" case
        
        
     # Verify Add Edit and Delete Misbranding/Mislabeled Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Misbranding/Mislabeled complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Misbranding/Mislabeled complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Misbranding/Mislabeled complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Misbranding/Mislabeled complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Misbranding/Mislabeled Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Misbranding/Mislabeled complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Misbranding/Mislabeled complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Misbranding/Mislabeled complaint type with all data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Misbranding/Mislabeled complaint type with all data for Submitted "Active" case


    # Verify Add Edit and Delete Off Taste/Off Odor/Off Appearance Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Off Taste/Off Odor/Off Appearance complaint type with mandatory data for Create New case

    Scenario: Verify user can Add ,edit and delete Off Taste/Off Odor/Off Appearance complaint type with mandatory data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Off Taste/Off Odor/Off Appearance complaint type with mandatory data for Submitted "New" case

    Scenario: Verify user can can Add , edit and delete Off Taste/Off Odor/Off Appearance complaint type with mandatory data for Submitted "Active" case

    # Verify Add Edit and Delete Off Taste/Off Odor/Off Appearance Complaint type with All Form data
    Scenario: Verify user can Add ,edit and delete Off Taste/Off Odor/Off Appearance complaint type with all data for Create New case

    Scenario: Verify user can Add ,edit and delete Off Taste/Off Odor/Off Appearance complaint type with all data for "Draft" case

    Scenario: Verify user can can Add , edit and delete Off Taste/Off Odor/Off Appearance complaint type with all data for Submitted "New" case
   ...
   # Verify Add Edit and Delete Other(Non-Specific) Complaint type with Mandatory Form data
    Scenario: Verify user can Add , edit and delete Other(Non-Specific) complaint type with mandatory data for Create New case.
        ...
        Then the user can see text "Select a User to Login:"
            ...
            # Edit Complaint type
            And the user "Edit" the Complaint type record with Complaint Type:"Other" , Medical Visit:"None" and Complaint Description:"Current Value Of#Other:Additional Description-field" on "Score/CCMS/Case/ComplaintType" page
            And the user selects "Other (Non-Specific)" from "Other:Concern-field" drop down on "Score/CCMS/Case/ComplaintType" page
            And the user enters unique "Unique Additional Description" into "Other:Additional Description-field" text area box on "Score/CCMS/Case/ComplaintType" page
            And the user remembers the value of "Other:Additional Description-field" text area on "Score/CCMS/Case/ComplaintType" page
            And the user clicks the "Other:Save" button on "Score/CCMS/Case/ComplaintType" page
            And the user can see "Successfully edited complaint type." text in "Complaint Type:Success Alert Message" field on "Score/CCMS/Case/ComplaintType" page
    ...
    @DRAFT_OTHER_COM_TYPE_UAT
    Scenario: Verify user can Add , edit and delete Other(Non-Specific) complaint type with mandatory data for "Draft" case.
        Given the user navigates to /score on browser
        And the user clicks the link with text "CCMS"
        Then the user can see text "Select a User to Login:"
        And the user selects "Gupta, Sam" from "Select User" drop down on "Score/User/User/Login" page
    ...
    @NEW_OTHER_COM_TYPE_UAT
    Scenario: Verify user can can Add ,edit and delete Other(Non-Specific) complaint type with mandatory data for Submitted "New" case
        Given the user navigates to /score on browser
        And the user clicks the link with text "CCMS"
        Then the user can see text "Select a User to Login:"
        And the user selects "Gupta, Sam" from "Select User" drop down on "Score/User/User/Login" page
...
#        And the user clicks the "Save" button on "Score/Dialog" page if opens
    ...
    @ACTIVE_OTHER_COM_TYPE_UAT
    Scenario: Verify user can can Add , edit and delete Other(Non-Specific) complaint type with mandatory data for Submitted "Active" case
        Given the user navigates to /score on browser
        And the user clicks the link with text "CCMS"
        Then the user can see text "Select a User to Login:"
        And the user selects "Gupta, Sam" from "Select User" drop down on "Score/User/User/Login" page
        ...
        And the user clicks the link with text "Case List"
        And the user "clicks" the "Current Value of#Create New Case:Case Number" case number record on View Case table on "Score/CCMS/ViewcaseList" page
        # Add Tasks to Change Case Status to Active
        ...
        And the user can "see" tasks under Brand Name-"Current Value of#Products:Product Brand-field",Product Name-"Current Value of#Products:Product Name/Type-field" with Task Type-"Current Value of#Tasks:Add Tasks:Task1 Type",Created on-"Current Value of#Tasks:Add Tasks:Task1 Created On",Current Status-"Active" and Assigned to-"Jaclynn Gilbert" in Add Contacts table
